    ...
    <header>
        <div class="wrapper">
            <ul class="menu">
                ...
                @can('create')
                <li class="menu__list-item"><a href="{{ route('articles.create') }}" class="menu__link link">Создать статью</a></li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('comments.get') }}">Comments <span class="sr-only">(current)</span></a>
                </li>
                @endcan 
